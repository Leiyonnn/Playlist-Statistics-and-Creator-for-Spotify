    ...
    try:
        ...
        <body>
            <div class="container">
                ...
                <div class="actions">
                    <a href="/search-new-songs" class="button">Discover New Songs by Genre</a>
...
def search_new_songs():
    """Search for new songs by genre from Spotify"""
    genre = request.args.get("genre", "")
    
    if not genre:
        #No gengre provided, show selection interface using cached session data
        ...
        <html>
        <head>
            <title>Discover New Songs</title>
            <style>
                body {{
                    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
                    max-width: 800px;
        ...
        <body>
            <div class="container">
                ...
                <p style="text-align: center; color: #666;">Select a genre to find new music recommendations</p>
                
                <div class="genre-grid">
                    {''.join([f'<a href="/search-new-songs?genre={g[0]}" class="genre-button">{g[0].title()}<br><small>{g[1]} in your library</small></a>' for g in top_genres])}
                </div>
